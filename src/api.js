...
export const getEvents = async () => {
  // if using localhost return mock data
  if (window.location.href.startsWith('http://localhost')) {
    return mockData;
  }
  // if user offline load event list data stored in localStorage
  if (!navigator.onLine) {
...
// remove code from URL once finished with out (streamline URL for user)
const removeQuery = () => {
  let newurl;
...
// Get new token if invalid or doesn't exist
